...
<body>
    ...
    <center><p><font color="black" size="5"> Patient Login</font></p></center><br/>

    <center>
        <form name="myform" action="patientact.jsp" method="post">    <table border="0" >

    <tr><td><font color="black"> User Name</td><td><input type="text" name="username" required="" Placeholder="User Name" /></td></tr>
    ...
    <br/>
    <center><a href="patientreg.jsp">New User..?Register Here...</a> </center>
