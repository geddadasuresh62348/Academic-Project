...
<body>
  ...
  <li><a href="doctorhome.jsp">Home</a></li>
    <li><a href="docviewreq.jsp">Booking Request</a>  
         <li><a href="viewfeed.jsp" class="selected">View Feedback</a>  
...
<%@ page session="true" %>
    ...
    String query1="select * from feedback where doctor='"+doctor+"' "; 
    Statement st1=co.createStatement();
    ResultSet rs=st1.executeQuery(query1);
      
    %>
    <center>
        <h2><font color="black" size="5"> View Feedback </font></h2>
       
                    <table border="2" width="50%">

                        <tr style="background-color: #FC339D">
                            <th><font color="black">Patient </th>
                            <th><font color="black">Feedback</th>
        ...
        <th><font color="black"><textarea><%=rs.getString("feedback")%></textarea></font></th>
           </tr>
            <%
                }
                } catch (Exception e) {
