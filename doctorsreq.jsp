...
<body>
  ...
  <li><a href="adminhome.jsp">Home</a></li>
    ...
    <li><a href="doctorsreq.jsp" class="selected">Doctors's Req</a></li>
...
<%@ page session="true" %>
    ...
    String query1="select * from bookings where status = 'finaladmin'"; 
    ...
    <center>
        ...
        <th><font color="black"><a href="activate.jsp?patient=<%=rs.getString("patient")%>&doctor=<%=rs.getString("doctor")%>&reason=<%=rs.getString("reason")%>">Approve</a></font></th>
        </tr>
            <%
                }
                } catch (Exception e) {
