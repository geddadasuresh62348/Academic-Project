...
if (atposition<1 || dotposition<atposition+2 || dotposition+2>=x.length){  
  ...
  return false;
    ...
    <li><a href="patient.jsp" class="selected">Patient</a></li>
    </ul>
    <br style="clear: left" />
    </div>
    ...
    <p align="justify">
    <center><p><font color="black" size="5"> Patient Registration</font></p></center><br/>
 
         <form name="myform" id="loginForm" action="register" method="get"  onsubmit="return validateform()" >

    <center><table width="391">
    <tr>
    ...
    <tr>
    <td height="43"><font color="black">Address</td>
    <td><input name="address" required="" placeholder="Address"></input></td>
    </tr> 
            
    <tr>
    <td height="43"><font color="black">Report</td>
    <td><input name="report" type="file" required="" placeholder="Address"></input></td>
    </tr>         
